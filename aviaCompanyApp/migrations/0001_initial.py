    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PLD', 'Запланирован'), ('EXP', 'Ожидается'), ('PRP', 'В подготовке'), ('IFL', 'В полете'), ('CTD', 'Выполнен'), ('CLD', 'Отменен'), ('DLD', 'Задерживается')])),
                ('price', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField()),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='aviaCompanyApp.cart')),
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
