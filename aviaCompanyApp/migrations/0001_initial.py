...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('PSP', 'Паспорт'), ('BRT', 'Свидетельство о рождении'), ('IPS', 'Заграничный паспорт')])),
            ...
            options={
                'unique_together': {('custom_name', 'owner'), ('number', 'type', 'date_of_issue', 'custom_name')},
            },
        ),
        migrations.CreateModel(
            name='Flight',
            fields=[
                ...
                ('status', models.CharField(choices=[('PLD', 'Ожидается регистрация'), ('EXP', 'Идет регистрация'), ('PRP', 'Посадка'), ('PRE', 'Посадка окончена'), ('IFL', 'В процессе'), ('CTD', 'Выполнен'), ('CLD', 'Отменен'), ('DLD', 'Задерживается')])),
                ('gate', models.IntegerField(blank=True, null=True)),
                ('exit_terminal', models.CharField(blank=True, null=True)),
                ('register_dtime', models.DateTimeField(blank=True, null=True)),
                ('boarding_dtime', models.DateTimeField(blank=True, null=True)),
                ('price', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ticket_slug', models.SlugField(unique=True)),
                ('price', models.IntegerField()),
                ('purchased', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('cart', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='aviaCompanyApp.cart')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_num', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='aviaCompanyApp.ticket')),
            ],
            options={
